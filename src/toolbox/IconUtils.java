...
public final class IconUtils {
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[] {readImageToBuffer(IconUtils.class.getResourceAsStream("../iconx16.png")), readImageToBuffer(IconUtils.class.getResourceAsStream("../iconx32.png"))};
        }catch(IOException e) {
            e.printStackTrace();
        }
        return null;
